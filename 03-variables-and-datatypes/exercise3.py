...
visited_countries_as_tuple = ("Latvia", "Guyana", "Yemen", "Yemen","Uzbekistan", "Latvia")
# visited_countries_as_tuple[0] = "Croatia" #TypeError: 'tuple' object does not support item assignment
